...
dat <- subset(tmp,cohort==1|cohort==4)
...
write.csv(effm, "./effm_1.csv", row.names=FALSE)
write.csv(pmp, "./pmp_1.csv", row.names=FALSE)
write.csv(ss, "./ss_1.csv", row.names=FALSE)
write.csv(effci, "./ci_1.csv", row.names=FALSE)
