...
for (N in sample_sizes) {
  folder_path <- paste0("C:/Users/feiyi/Desktop/MEMs/mcmc/1_1_1_1/", N)
...
write.csv(results, "C:/Users/feiyi/Desktop/github_MEMs/MEMs/Simulation/Results/Equal/Results for Combine/mcmc_uni_1_1_1_1.csv", row.names=FALSE)